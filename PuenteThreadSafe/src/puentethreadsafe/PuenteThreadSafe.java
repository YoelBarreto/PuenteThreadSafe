...
/*
    ...
    - El tiempo de paso de las personas es aleatorio, entre 10 y 50 segundos.
    ...
    public static void main(String[] args) {
        ...
        int numeroPersona = 0;
            while (true) {
                ...
                System.out.printf("La %s llegará en %d segundos, pesa %d kilos y tardara %d segundos en cruzar \n",
